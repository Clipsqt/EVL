function searchTable() {
    ...
    $(document).ready(function() {
        ...
        $("button#backButton").click(function() {
            // Send an AJAX request to delete the last inserted data and update the series counter
            $.ajax({
                url: 'delete_last_inserted_data.php',
                method: 'POST',
                success: function(response) {
                    console.log(response); // Log the response for debugging
                    // Redirect to the logs history page after successful deletion
